...
- [Composable FastAPI Lifespans](docs/lifespan.md)
- [Dispatching Webhooks Internally](docs/dispatching.md)
...
pattern described in [docs/dispatching.md](docs/dispatching.md).
